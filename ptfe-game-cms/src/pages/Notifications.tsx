...
import { NotificationsTable } from 'components/shared/tables/NotificationsTable';
import { NotificationFormModal } from 'components/shared/forms/NotificationFormModal';
import { Notification } from 'api/notification/types';
import { deleteNotification, getNotificationsWithFilter } from 'api/notification';


export const Notifications = () => {
    const [itemForUpdate, setItemForUpdate] = useState<Notification | null>(null);
    ...
    const { data, refetch, isLoading } = useQuery(['notification'], () => getNotificationsWithFilter(filters));
