...
import { SliderCardFormModal } from 'components/shared/forms/SliderCardFormModal';
import { SliderCardTable } from 'components/shared/tables/SliderCardsTable';
import { SliderCard } from 'api/sliderCard/types';
import { deleteSliderCards, getSliderCardsWithFilter } from 'api/sliderCard';


export const SliderCards = () => {
    const [itemForUpdate, setItemForUpdate] = useState<SliderCard | null>(null);
    ...
    const { mutate } = useMutation(deleteSliderCards);

    const { data, refetch, isLoading } = useQuery(['slider-card'], () => getSliderCardsWithFilter(filters));
